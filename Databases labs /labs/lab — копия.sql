...
SELECT DISTINCT Contents, COUNT(*) FROM Boxes GROUP BY Contents;
	
SELECT Warehouse, COUNT(*) FROM Boxes GROUP BY Warehouse; 
	
SELECT Warehouse, COUNT(*) FROM Boxes GROUP BY WarehouseHAVING COUNT(*) > 2; 
		
INSERT INTO Warehouses(Code,Location,Capacity) VALUES(8,'New York',3);
